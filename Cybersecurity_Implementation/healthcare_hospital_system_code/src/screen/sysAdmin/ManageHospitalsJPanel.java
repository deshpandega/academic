...
public class ManageHospitalsJPanel extends javax.swing.JPanel {
     ...
     */
    ManageHospitalsJPanel(JPanel cardContainer, UserAccount account, EcoSystem ecoSystem) {
        initComponents();
    ...
    private void initComponents() {
        ...
        txtHeading.setText("Manage Hospitals - Add Departments");
        ...
        cmbHospitals.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                cmbHospitalsActionPerformed(evt);
            }
        });
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    ...
                                    .addComponent(cmbHospitals, 0, 262, Short.MAX_VALUE))
                                .addGap(44, 44, 44)
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addGroup(layout.createSequentialGroup()
    ...
    private void cmbHospitalsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmbHospitalsActionPerformed
        // TODO add your handling code here:
        if(cmbHospitals.getSelectedItem().equals("Select a branch")){
            jLabel2.setVisible(false);
            cmbDepartments.setVisible(false);
            btnAddDepartment.setVisible(false);
            selectedHospitalBranch = null;
        }
        else{
            selectedHospitalBranch = (Hospital)cmbHospitals.getSelectedItem();
    ...
    }//GEN-LAST:event_cmbHospitalsActionPerformed
