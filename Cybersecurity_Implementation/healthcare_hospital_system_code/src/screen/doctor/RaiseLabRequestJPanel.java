 ...
 */
public class RaiseLabRequestJPanel extends javax.swing.JPanel {
     ...
     */
    RaiseLabRequestJPanel(JPanel cardContainer, UserAccount account, Hospital hospital, Patient patient) {
        initComponents();
    ...
    private void populateTable(){
        ...
        for (WorkRequest request : account.getWorkQueue().getWorkRequestList()) {
            if (request instanceof LabWorkRequest) {
                ...
                String outcome = ((LabWorkRequest) request).getRequestOutcome();
                row[4] = outcome == null ? "Waiting" : outcome;
                String result = ((LabWorkRequest) request).getComments();
    ...
    private void initComponents() {
        ...
        lblHeading.setText("Raise Lab Request");
        ...
        btnRaiseRequest.setText("Raise Lab Request");
    ...
    private void btnRaiseRequestActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRaiseRequestActionPerformed
        // TODO add your handling code here:
        AddNewSpecialRequestJPanel addNewSpecialRequestJPanel = new AddNewSpecialRequestJPanel(cardContainer, account, hospital, patient, "LabRequest");
    ...
    private void btnViewRequestActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnViewRequestActionPerformed
        ...
        if(selectedRow<0){
            ...
            ViewSpecialRequestJPanel viewSpecialRequestJPanel = new ViewSpecialRequestJPanel(cardContainer, account, request, "LabRequest");
