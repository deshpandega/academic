 ...
 * @author infer
 */
public class ProcessSpecialRequestJPanel extends javax.swing.JPanel {

    private JPanel cardContainer;
    private UserAccount account;
    private SpecialMedicalWorkRequest request;
    private static Logger log;
    
    /**
     * Creates new form ManageSpecialRequestJPanel
     */
    ProcessSpecialRequestJPanel(JPanel cardContainer, UserAccount account, SpecialMedicalWorkRequest request) {
        initComponents();
        this.cardContainer = cardContainer;
        this.account = account;
        this.request = request;
        log = Logger.getLogger(ProcessSpecialRequestJPanel.class);
    ...
    private void initComponents() {
        ...
        lblHeading.setText("Process Requests");
    ...
    private void btnCompleteRequestActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCompleteRequestActionPerformed
        ...
        if(allDataEnteredCorrectly){
            ...
            log.info(UtilFunctions.encrypt("PRO_SPREQ : "+account.getEmployee()));
    ...
    private void goBack(){
        ...
        ManageSpecialRequestJPanel manageSpecialRequestJPanel = (ManageSpecialRequestJPanel) component;
        manageSpecialRequestJPanel.populateRequestsTable();
        CardLayout layout = (CardLayout) cardContainer.getLayout();
