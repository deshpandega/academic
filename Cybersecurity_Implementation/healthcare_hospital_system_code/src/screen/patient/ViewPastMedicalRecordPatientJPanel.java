 ...
 */
public class ViewPastMedicalRecordPatientJPanel extends javax.swing.JPanel {
     ...
     */
    ViewPastMedicalRecordPatientJPanel(JPanel cardContainer, UserAccount account, Patient patient, Hospital hospital, String recordType) {
        initComponents();
        ...
        log = Logger.getLogger(ViewPastMedicalRecordPatientJPanel.class);
        log.info(UtilFunctions.encrypt("VIEW_REC : "+account.getPatient().getPerson().getFirstName()+" "+account.getPatient().getPerson().getLastName()));
