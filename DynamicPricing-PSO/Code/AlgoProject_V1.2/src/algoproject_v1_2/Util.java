...
public class Util {
    ...
    //PSO variables according to Clerc and Kennedy 2002
    ...
    //Generic variables for PSO implementation
    ...
    //Variables / Constants for cost function
    public static double varAlphaMin = -5;
    public static double varAlphaMax = 5;
    ...
    public static double varBetaMin = -8.5;
    public static double varBetaMax = -0.048;
    ...
    public static double varEpsilonMin = -2;
    public static double varEpsilonMax = 2;
